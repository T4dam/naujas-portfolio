...
const Mywork = () => {
	const data = [
		...
		},
		{
			title: 'CoinTrack',
			intro:
				'Live crypto market charts and price comparison for those who want to keep track of crypto prices',
			src: imgcointrack,
			alt: 'CoinTrack page',
			url: '/work/cointrack',
		},
		{
			title: 'Tasky',
			intro:
				'A handy dandy time management tool for planners and time savers. You can easily track your task process with a drag and drop functionality.',
			src: tasky,
			alt: 'Task board page',
			url: '/work/tasky',
		},
		{
			title: 'Game Dungeon',
			intro:
				'A website for a funky looking fictional company that offers variety of services for gamers and beyond. ',
			src: dungeon,
		...
		},
		{
			...
			intro:
				'Collaborated with VeeHouse and famous Lithuanian hip-hop band "Dogma" for a song cover for youtube of their latest single called "Karalius nuogas".',
			src: cover,
							...
							<div className=" w-full h-auto text-center md:text-center flex flex-col sm:flex-row gap-8 max-gap-12 justify-between">
								<div className="flex justify-center sm:justify-start items-center snap-center">
									<div className=" max-w-full ">
										<h3 className="text-4xl md:text-6xl font-black text-center sm:text-left mb-6">
											{item.title}
										</h3>
										<p className="max-w-[360px] md:max-w-[400px] sm:w-full text-center sm:text-left sm:text-lg leading-7 mb-6">
											{item.intro}
										</p>
