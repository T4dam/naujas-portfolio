...
const PorfolioHero = () => {
  return (
    // <section className='bg-gradient-to-b from-purple-400 to-slate-900 md:from-black-500 h-screen -mt-14'>
    ...
    //                 </div>
      <section className='bg-slate-900 h-screen -mt-14'>
        <div className='container mx-auto  w-full h-full pt-14 flex justify-center items-center'>
            <div className=' -mt-40 sm w-full max-w-6xl text-white flex flex-col gap-10 p-4'>
              <h2 className='text-center sm:text-left text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold font-black'>My Portfolio</h2>
          ...
          <div className='flex justify-center'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
