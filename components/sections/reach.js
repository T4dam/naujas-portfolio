    ...
    <section className='bg-gradient-to-t from-purple-900 via-slate-900 to-slate-900 md:from-black-500 h-full w-full flex justify-center text-white '>
        <div className='container flex justify-center mb-24'>
            <div className='w-full max-w-6xl flex-col items-center justify-center'>
                ...
                <button className='rounded-[4px] shadow-md m-1 h-16 border-solid border-2 border-white w-60 sm:w-72 hover:border-green-400 hover:bg-green-400 hover:text-black hover:text-green-400'>
                ...
                <button className='rounded-[5px] shadow-md m-1 h-16 border-solid border-2 border-white w-60 sm:w-72 hover:border-green-400 hover:bg-green-400 hover:text-black hover:text-green-400'>
