...
import aiddronpage from '/public/images/aiddron-pages.jpg';
	...
	return (
		<section className="bg-slate-900 h-full w-full text-white">
			<div className="container flex-col w-full h-full mx-auto flex p-4 sm:p-0 md:p-4 items-center">
				...
				<div className=" pic h-[500px] w-full max-w-5xl mx-auto  mt-14 mb-24 relative rounded-xl overflow-hidden">
					<Image
						src={aiddronpage}
